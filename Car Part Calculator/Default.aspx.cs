...
namespace Car_Part_Calculator
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void purchaseButton_Click(object sender, EventArgs e)
        {
            ...
            { // if Password not entered/correct reset default values
                setStdValues();
            }
            ...
            if (formOk) // if bool formOk is true
            {
                ...
                VAT = vatMethod();
                subTotal = basicPriceVar - tradeInPriceVar + (radioButtonsVar + chkBoxTotalVar);
